...
assert_grep_file 'edgeeye_wait_web_port' "$COMMON"
assert_grep_file 'edgeeye_ffmpeg_has_hls' "$COMMON"
assert_grep_file 'ffmpeg-riscv64-static' "$FFBUILD"
assert_grep_file 'edgeeye_deploy_ffmpeg' "$ROOT/deploy"
