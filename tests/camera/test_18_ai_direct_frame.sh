...
assert_grep_file 'CAM_VPSS_AI_CHN_ID.*VPSS_CHN1' "$ROOT/apps/camera/cam_pipeline_config.h"
assert_grep_file 'CAM_AI_FRAME_WIDTH.*448' "$ROOT/apps/camera/cam_pipeline_config.h"
assert_grep_file 'CAM_VPSS_AI_CHN_ID' "$EXPORT"
